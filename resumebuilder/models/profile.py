...
class Profile:
    ...
    def __init__(self, file_prefix):
        ...
        with open(full_filename, 'r') as json_file:
            ...
            self.personal_info = PersonalInfo(data['personal_info'])
            self.summary = data['summary']
            self.educators = [School(school_json) for school_json in data['educators']]
            self.employers = [Employer(employer_json) for employer_json in data['employers']]
